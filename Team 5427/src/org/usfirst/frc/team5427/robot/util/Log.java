...
public class Log {
	...
	/**
	 * Logging temporary, or unimportant debug information -- will only show up if DEBUG_MODE is enabled
	 * @param text
	 */
	...
	/**
	 * Logging more important warnings -- will still show up even if LOGGING_ENABLED is false
	 * @param text
	 */
	...
	/**
	 * Logging fatal, or otherwise important warnings or errors -- will still show up even if LOGGING_ENABLED is false.
	 * @param text
	 */
